...
export const masterVerbList: Verb[] = [
  ...
  { dictionary: '称する', meaning: 'to call oneself; to pretend', type: 'suru', difficultyLevel: 'hard' },
  ...
  { dictionary: '屈する', meaning: 'to yield; to give in', type: 'suru', difficultyLevel: 'hard' },
  ...
  { dictionary: '催促する', meaning: 'to urge; to press', type: 'suru', difficultyLevel: 'hard' },
  { dictionary: '駆使する', meaning: 'to make full use of', type: 'suru', difficultyLevel: 'hard' },
  ...
  { dictionary: '承知する', meaning: 'to consent; to be aware', type: 'suru', difficultyLevel: 'hard' },
  { dictionary: '応じる', meaning: 'to respond; to comply', type: 'ichidan', difficultyLevel: 'hard' },
  { dictionary: '改善する', meaning: 'to improve', type: 'suru', difficultyLevel: 'hard' },
  { dictionary: '妥当する', meaning: 'to be appropriate', type: 'suru', difficultyLevel: 'hard' },
  { dictionary: '維持する', meaning: 'to maintain; to preserve', type: 'suru', difficultyLevel: 'hard' },
  ...
  { dictionary: '採用する', meaning: 'to employ; to adopt', type: 'suru', difficultyLevel: 'hard' },
  { dictionary: '推進する', meaning: 'to promote; to propel', type: 'suru', difficultyLevel: 'hard' },
  { dictionary: '設ける', meaning: 'to establish; to create', type: 'ichidan', difficultyLevel: 'hard' },
  { dictionary: '強調する', meaning: 'to emphasize', type: 'suru', difficultyLevel: 'hard' },
  ...
  { dictionary: '契約する', meaning: 'to contract; to make an agreement', type: 'suru', difficultyLevel: 'hard' },
  { dictionary: '支配する', meaning: 'to control; to dominate', type: 'suru', difficultyLevel: 'hard' },
